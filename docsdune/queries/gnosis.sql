-- ETH Cali — Onchain Activity Score · Gnosis
-- Dataset: dune.ethcali.dataset_users_onboarded_eth_cali
-- Score: native_txns×1 + token_txns×2 + volume_usd÷100 + contracts×3
-- Note: Gnosis is the home chain of POAPs — most ETH Cali wallets have activity here
...
contracts AS (
  ...
  FROM gnosis.creation_traces tr
  INNER JOIN dataset d ON tr."from" = d.address
  GROUP BY 1
)
